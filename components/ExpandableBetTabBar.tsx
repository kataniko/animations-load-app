        ...
        <Animated.View pointerEvents={expanded ? 'auto' : 'none'} style={[styles.expandedContent, expandedContentStyle]}>
          ...
          <View style={styles.stepRow}>
            {steps.map((item, index) => (
              <View
                key={item.label}
                style={[styles.stepSegment, index <= step && styles.stepSegmentActive]}
              />
            ))}
          </View>

          <Text style={[styles.helperText, { color: theme.accent }]}>{currentStep.helper}</Text>
            ...
            {currentStep.options.map((option) => {
              ...
              return (
                <Pressable
                  ...
                  style={[styles.leagueChip, { backgroundColor: theme.surfaceElevated, borderColor: theme.border }, selected && styles.leagueChipSelected]}>
